...
function Navbar() {
    ...
    return (
        <div>
            ...
            <div className = "intro">
                <h1 style ={{fontSize : '18px', fontWeight : 'bold'}}>Know Polling Queue Estimates, Cast Your Vote!<br/>ਪੋਲਿੰਗ ਕਤਾਰ ਦੇ ਅਨੁਮਾਨਾਂ ਨੂੰ ਜਾਣੋ, ਆਪਣੀ ਵੋਟ ਪਾਓ!</h1>
                ...
                <button className = "nav_btn" onClick = {() => window.open('https://electoralsearch.eci.gov.in/', '_blank')}>Know your Constituency and Part Number(Part Serial Number)<br />ਆਪਣੇ ਚੋਣ ਖੇਤਰ ਅਤੇ ਭਾਗ ਨੰਬਰ (ਪਾਰਟ ਸੀਰੀਅਲ ਨੰਬਰ) ਜਾਣੋ</button>
            </div>
        </div>
    )
}
